    ...
    <div className="min-h-screen py-10">
      <div className="max-w-screen-lg mx-auto px-4">
        <div className="mb-16 pt-16">
          {/* Added padding-top for more space above the carousel */}
          <Carousel
            showThumbs={false}
            infiniteLoop
            useKeyboardArrows
            ...
            <div className="p-4">
              <div className="rounded-lg shadow-lg p-6 text-center">
                ...
                <Button
                  ...
                  className={`w-full bg-blue-400 text-black rounded hover:from-blue-500 hover:to-purple-400 transition duration-150 ${
                    theme === 'dark' ? 'bg-blue-600' : ''
                  }`}
                >
                  Enroll Now
